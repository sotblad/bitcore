...
export class CurrencyValueComponent implements OnChanges {
  ...
  amount: number;
  /**
   * The currency code/ticker symbol of the value. (E.g. when displaying a MUE
   * value from the Bitcore API, this should likely be `MUE_satoshis`, even if
   ...
   * unit in which to display the value. (E.g. `MUE_bits`, `MUE`, `USD`, etc.)
   *
