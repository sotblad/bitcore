...
describe('BufferReader', function() {
  ...
  describe('#readUInt64LEBN', function() {
    ...
    it('should return 10BTX', function() {
      var tenbtx = 10 * 1e8;
      var tenbtxBuffer = new Buffer('00ca9a3b00000000', 'hex');
      var br = new BufferReader(tenbtxBuffer);
      br.readUInt64LEBN().toNumber().should.equal(tenbtx);
    });
