...
var validbase58 = require('./data/bitcored/base58_keys_valid.json');
var invalidbase58 = require('./data/bitcored/base58_keys_invalid.json');
...
describe('PrivateKey', function() {
  ...
  describe('bitcored compliance', function() {
