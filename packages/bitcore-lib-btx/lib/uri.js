...
/**
 * Internal function to transform a BTX string amount into satoshis
 *
 * @param {string} amount - Amount BTX string
 * @throws {TypeError} Invalid amount
...
URI.prototype._parseAmount = function(amount) {
  ...
  return Unit.fromBTX(amount).toSatoshis();
};
...
URI.prototype.toString = function() {
  var query = {};
  if (this.amount) {
    query.amount = Unit.fromSatoshis(this.amount).toBTX();
  }
  if (this.message) {
